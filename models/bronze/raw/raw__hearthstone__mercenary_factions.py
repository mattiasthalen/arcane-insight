...
@model(
    ...
    description='Extract & load model for the mercenary factions endpoint from the Hearthstone API.',
    kind=dict(
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    # Fetch data
    base_url = "https://eu.api.blizzard.com/hearthstone/metadata/mercenaryFactions"
