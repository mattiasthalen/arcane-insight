...
@model(
    ...
    description='Extract & load model for the cardback categories endpoint from the Hearthstone API.',
    cron="*/5 * * * *",
    kind=dict(
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    # Fetch data
    base_url = "https://eu.api.blizzard.com/hearthstone/metadata/cardBackCategories"
