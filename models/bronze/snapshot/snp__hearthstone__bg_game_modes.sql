/* Snapshot model of the bg game modes from Hearthstone */
MODEL (
  name bronze.snapshot.snp__hearthstone__bg_game_modes,
...
SELECT
  *,
  @generate_surrogate_key__sha_256(
    @star_v2(
      relation := raw__hearthstone__bg_game_modes,
...
FROM bronze.raw.raw__hearthstone__bg_game_modes