/* Snapshot model of the cardback categories from Hearthstone */
MODEL (
  name bronze.snapshot.snp__hearthstone__cardback_categories,
...
SELECT
  *,
  @generate_surrogate_key__sha_256(
    @star_v2(
      relation := raw__hearthstone__cardback_categories,
...
FROM bronze.raw.raw__hearthstone__cardback_categories